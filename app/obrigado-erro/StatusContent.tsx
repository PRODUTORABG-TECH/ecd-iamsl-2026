...
export default function StatusContent() {
  // 1. O hook do Next.js lê os parâmetros diretamente do navegador do utilizador
  ...
  // 2. Verifica se a pessoa abandonou o checkout
        ...
        {foiAbandono ? (
          <>
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-6">
              Notamos que voltou antes de concluir o pagamento. A sua inscrição ainda <strong>não foi finalizada</strong>.
            </p>
          ...
          <>
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Lamentamos, mas ocorreu um erro durante o processo ou o pagamento foi recusado. Por favor, entre em contacto com a equipa para obter ajuda.
            </p>
            <div className="mt-6 text-sm text-gray-700">
              <p className="font-semibold">Contacte a equipe:</p>
              <Link
                href="https://wa.me/5527997558607?text=Tive%20um%20problema%20ao%20realizar%20meu%20cadastro%20no%20Encontro%20com%20Deus%202026%20e%20preciso%20de%20ajuda%20para%20corrigir%20as%20informa%C3%A7%C3%B5es."
                className="block mt-2"
                target="_blank"
